...
def data_get():
    city = city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=7cb507869db01af80a0841597f118513").json()
...
com = ttk.Combobox(win , text="Weather Forecasting " , values=list_name, font=("Times New Roman" , 20 , "bold"), textvariable=city_name)

com.place(x=25 , y=120 , height=50 ,width=450)

w_label = Label(win , text="Weather" , font=("Times New Roman" , 15 , "bold"))
w_label.place(x=25 , y=260 , height=50 ,width=100)
w_label1 = Label(win , text="" , font=("Times New Roman" , 15 , "bold"))
