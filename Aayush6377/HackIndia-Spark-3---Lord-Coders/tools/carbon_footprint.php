...
<head>
    ...
    <style>
        ...
        .recommendation h3 {
            margin-top: 0;
            color: #c62828; /* Red for recommendations */
        }
    </style>
</head>
<body>
    ...
    <main>
        <div class="carbon-calculator-container">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                // Set average values for comparison (example values in kg CO2 per year)
                $average_car_emission = 3000; // Example average value
                $average_energy_emission = 3000; // Example average value
                $average_waste_emission = 600; // Example average value

                // Determine category
                $category = '';
                if ($total_emission > $average_car_emission + $average_energy_emission + $average_waste_emission) {
                    $category = 'Excessive';
                } elseif ($total_emission > ($average_car_emission + $average_energy_emission + $average_waste_emission) * 0.75) {
                    $category = 'Medium';
                } else {
                    $category = 'Low';
                }
                ...
                echo "<h3>Your Carbon Footprint Category: " . $category . "</h3>";
                echo "<p>";
                if ($category === 'Excessive') {
                    echo "Your carbon footprint is higher than average. Consider reducing your car travel, conserving energy, and minimizing waste to lower your impact.";
                } elseif ($category === 'Medium') {
                    echo "Your carbon footprint is around average. There is room for improvement in reducing car travel, energy consumption, and waste generation.";
                } else {
                    echo "Congratulations! Your carbon footprint is lower than average. Continue your efforts to maintain and improve your sustainable practices.";
                }
                echo "</p>";
                echo "</div>";
            }
