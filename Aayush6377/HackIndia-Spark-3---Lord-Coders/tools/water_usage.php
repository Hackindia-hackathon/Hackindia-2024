    ...
    <main>
        <div class="water-calculator-container">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                // Define average usage values for recommendations
                $average_usage = 200000; // average water usage in liters per year
                $low_threshold = $average_usage * 0.75; // 75% of average
                $high_threshold = $average_usage * 1.25; // 125% of average
                ...
                if ($total_water < $low_threshold) {
                    echo "<p>Your water usage is excellent and well below average. Great job on conserving water!</p>";
                } elseif ($total_water > $high_threshold) {
                    echo "<p>Your water usage is higher than average. Consider adopting water-saving practices to reduce your consumption.</p>";
                } else {
                    echo "<p>Your water usage is around the average range. Keep up the good work, but there may still be opportunities to save more water.</p>";
                }
                echo "</div>";
                echo "</div>";
            }
