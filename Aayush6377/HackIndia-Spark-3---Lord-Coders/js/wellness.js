const questions = [
    { question: "How often do you exercise per week?", options: ["Every day", "3-5 times", "1-2 times", "Rarely or never"], correct: 0 },
    { question: "How many servings of fruits and vegetables do you consume daily?", options: ["5 or more", "3-4", "1-2", "None"], correct: 0 },
    { question: "How many hours of sleep do you get each night?", options: ["8 or more", "6-7", "4-5", "Less than 4"], correct: 0 },
...
function showResults() {
    ...
    if (score > 10) {
        resultText.textContent = "Score: "+score+"\nGreat job! You have a good understanding of wellness programs.";
    } else if (score > 5) {
        resultText.textContent = "Score: "+score+"\nGood effort! Consider incorporating more wellness practices into your routine.";
    } else {
        resultText.textContent = "Score: "+score+"\nYou might benefit from learning more about wellness programs.";
    }
