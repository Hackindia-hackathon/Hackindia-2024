 ...
 * running for use with Celeriz: Functions to help fill out a contact list, add
...
/**
 * Clear out Celeriz's localStorage entries, effectively "deleting the user's account."
