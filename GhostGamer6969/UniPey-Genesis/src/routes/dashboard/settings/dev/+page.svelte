...
"profile" into a useable state for experimenting with Celeriz and with the
...
friendbot, and completely erase all the `localStorage` we have for Celeriz and
start fresh.
-->
...
<p>
    ...
    into a useable state for experimenting with Celeriz and with the testnet. Utilities are available
    ...
    friendbot, and completely erase all the `localStorage` we have for Celeriz and start fresh.
</p>
...
<p>Tired of your Celeriz setup? Nuke the whole gosh-darn thing!</p>
